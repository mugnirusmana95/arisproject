...
@section('title')
Laporan Barang Masuk Dari Supplier Tanggal {{$date}}
@endsection
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li><a href="{{route('report.gisup.index')}}">Laporan Barang Masuk Dari Supplier</a></li>
...
<section class="content">
  ...
  <div class="box box-default">
    ...
    <div class="box-footer">
      @if (count($gisup)>0)
      <form action="{{route('report.gisup.printToday')}}" method="post" target="_blank">
        {{ csrf_field() }}
        <input type="hidden" name="sekarang" value="{{$date}}">
