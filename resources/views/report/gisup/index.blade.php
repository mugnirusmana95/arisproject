...
@section('title')
Laporan Barang Masuk Dari Supplier
@endsection
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li class="active">Laporan Barang Masuk Dari Supplier</li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="box box-default">
    ...
    <form class="form-horizontal" method="post" action="{{route('report.gisup.checkPeriode')}}">
      {{ csrf_field() }}
  ...
  <div class="box box-default">
    ...
    <form class="form-horizontal" method="post" action="{{route('report.gisup.checkDate')}}">
      {{ csrf_field() }}
  ...
  <div class="box box-default">
    ...
    <form class="form-horizontal" method="post" action="{{route('report.gisup.checkToday')}}">
      {{ csrf_field() }}

      <div class="box-body">

        <div class="form-group {{$errors->has('sekarang') ? 'has-error' : ''}}">
          <label for="periode" class="control-label col-md-2">Tanggal Hari Ini <span class="req">*</span></label>
          <div class="col-md-9">
            <input type="text" class="form-control" name="sekarang" id="sekarang" readonly style="background-color:#FFF" value="{{$today}}">
            <p class="help-block">
              @if ($errors->has('tanggal'))
                {{$errors->first('tanggal')}}
              @endif
