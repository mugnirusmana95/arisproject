...
@section('title')
Laporan Barang Keluar Oleh Sales Tanggal {{$date}}
@endsection
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li><a href="{{route('report.gosales.index')}}">Laporan Barang Keluar Oleh Sales</a></li>
...
<section class="content">
  ...
  <div class="box box-default">
    ...
    <div class="box-footer">
      @if (count($gosales)>0)
      <form action="{{route('report.gosales.printToday')}}" method="post" target="_blank">
        {{ csrf_field() }}
