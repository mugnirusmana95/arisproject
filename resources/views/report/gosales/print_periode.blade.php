...
@section('title')
Laporan Barang Keluar Oleh Sales Dari {{$date_start}} s/d {{$date_end}}
@endsection
...
<div class="A4_portrait">
  ...
  <br>
  <br>
  <center><font size="4px"><b>Laporan Barang Keluar Oleh Sales ({{$date_start}} s/d {{$date_end}})</b></font></center>
  <br>
  <br>
