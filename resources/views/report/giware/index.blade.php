...
@section('title')
Laporan Barang Masuk Dari Cabang
@endsection
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li class="active">Laporan Barang Masuk Dari Cabang</li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="box box-default">
    ...
    <form class="form-horizontal" method="post" action="{{route('report.giware.checkPeriode')}}">
      {{ csrf_field() }}
  ...
  <div class="box box-default">
    ...
    <form class="form-horizontal" method="post" action="{{route('report.giware.checkDate')}}">
      {{ csrf_field() }}
  ...
  <div class="box box-default">
    ...
    <form class="form-horizontal" method="post" action="{{route('report.giware.checkToday')}}">
      {{ csrf_field() }}
