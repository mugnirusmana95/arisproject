...
@section('title')
Laporan Barang Masuk Dari Cabang Dari {{$date_start}} s/d {{$date_end}}
@endsection
...
<div class="A4_portrait">
  ...
  <br>
  <br>
  <center><font size="4px"><b>Laporan Barang Masuk Dari Cabang ({{$date_start}} s/d {{$date_end}})</b></font></center>
  <br>
  <br>
