...
@section('title')
Laporan Barang Masuk Dari Sales Dari {{$date_start}} s/d {{$date_end}}
@endsection
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li><a href="{{route('report.gisales.index')}}">Laporan Barang Masuk Dari Sales</a></li>
...
<section class="content">
  ...
  <div class="box box-default">
    ...
    <div class="box-footer">
      @if (count($gisales)>0)
      <form action="{{route('report.gisales.printPeriode')}}" method="post" target="_blank">
        {{ csrf_field() }}
