...
@section('title')
Laporan Barang Masuk Dari Sales
@endsection
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    <li class="active">Laporan Barang Masuk Dari Sales</li>
  </ol>
</section>
...
<section class="content">
  ...
  <div class="box box-default">
    ...
    <form class="form-horizontal" method="post" action="{{route('report.gisales.checkPeriode')}}">
      {{ csrf_field() }}
  ...
  <div class="box box-default">
    ...
    <form class="form-horizontal" method="post" action="{{route('report.gisales.checkDate')}}">
      {{ csrf_field() }}
  ...
  <div class="box box-default">
    ...
    <form class="form-horizontal" method="post" action="{{route('report.gisales.checkToday')}}">
      {{ csrf_field() }}
