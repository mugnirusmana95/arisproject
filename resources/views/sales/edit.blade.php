...
<section class="content">
  ...
  <div class="box box-default">
    ...
    <form class="form-horizontal" method="post" action="/master/sales/ubah/simpan/{{$sales->id}}" enctype="multipart/form-data">
      {{ csrf_field() }}
      ...
      <div class="box-body">
        ...
        <div class="form-group {{$errors->has('image') ? 'has-error' : ''}}">
          <label for="image" class="control-label col-md-2">Foto</label>
          <div class="col-md-8">
