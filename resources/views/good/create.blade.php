    ...
    <form class="form-horizontal" method="post" action="/master/barang/tambah/simpan">
      ...
      <div class="box-body">
        ...
        <div class="form-group {{$errors->has('name') ? 'has-error' : ''}}">
          ...
          <div class="col-md-8">
            <input type="text" class="form-control" name="name" placeholder="Masukan Nama Barang" value="{{old('name')}}">
            <p class="help-block">
              @if ($errors->has('name'))
                {{$errors->first('name')}}
              @endif
        ...
        <div class="form-group {{$errors->has('qyt_box') ? 'has-error' : ''}}">
          ...
          <div class="col-md-8">
            <input type="text" class="form-control" name="qyt_box" placeholder="Masukan Jumlah Barang Per Box" value="{{old('qyt_box')}}">
            <p class="help-block">
        ...
        <div class="form-group {{$errors->has('qyt_pcs') ? 'has-error' : ''}}">
          ...
          <div class="col-md-8">
            <input type="text" class="form-control" name="qyt_pcs" placeholder="Masukan Jumlah Barang Per Pcs" value="{{old('qyt_pcs')}}">
            <p class="help-block">
        ...
        <div class="form-group {{$errors->has('pcs_per_box') ? 'has-error' : ''}}">
          ...
          <div class="col-md-8">
            <input type="text" class="form-control" name="pcs_per_box" placeholder="Masukan Jumlah Barang Per Box" value="{{old('pcs_per_box')}}">
            <p class="help-block">
