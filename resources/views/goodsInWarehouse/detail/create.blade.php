...
@section('title')
Tambah Detail Barang Masuk Dari Cabang
@endsection
...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="/barang_masuk/gudang/lihat/{{$giw->id}}">Detail Masuk Dari Cabang</a></li>
    <li class="active">Tambah Detail Barang Masuk Dari Cabang</li>
  </ol>
</section>
